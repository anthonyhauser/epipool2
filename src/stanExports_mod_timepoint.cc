...
#include "stanExports_mod_timepoint.h"

RCPP_MODULE(stan_fit4mod_timepoint_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mod_timepoint")
