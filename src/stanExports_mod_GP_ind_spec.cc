...
#include "stanExports_mod_GP_ind_spec.h"

RCPP_MODULE(stan_fit4mod_GP_ind_spec_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mod_GP_ind_spec")
