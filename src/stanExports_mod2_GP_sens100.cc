...
#include "stanExports_mod2_GP_sens100.h"

RCPP_MODULE(stan_fit4mod2_GP_sens100_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mod2_GP_sens100")
