...
namespace model_mod_timepoint_ind_spec_namespace {
...
class model_mod_timepoint_ind_spec final : public model_base_crtp<model_mod_timepoint_ind_spec> {
private:
  int N;
  int N_t;
  int N_pop;
...
public:
  ~model_mod_timepoint_ind_spec() { }
  
  inline std::string model_name() const final { return "model_mod_timepoint_ind_spec"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = %%NAME%%3 %%VERSION%%", "stancflags = "};
  }
  
  
  model_mod_timepoint_ind_spec(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mod_timepoint_ind_spec_namespace::model_mod_timepoint_ind_spec";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mod_timepoint_ind_spec_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mod_timepoint_ind_spec_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_mod_timepoint_ind_spec_namespace::model_mod_timepoint_ind_spec;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mod_timepoint_ind_spec_namespace::profiles__;
}
#endif
#endif
