...
#include "stanExports_mod1_timepoint.h"

RCPP_MODULE(stan_fit4mod1_timepoint_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mod1_timepoint")
