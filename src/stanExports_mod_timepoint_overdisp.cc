...
#include "stanExports_mod_timepoint_overdisp.h"

RCPP_MODULE(stan_fit4mod_timepoint_overdisp_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mod_timepoint_overdisp")
