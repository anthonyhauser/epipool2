...
#include "stanExports_mod3_timepoint.h"

RCPP_MODULE(stan_fit4mod3_timepoint_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mod3_timepoint")
