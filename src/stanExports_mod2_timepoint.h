...
namespace model_mod2_timepoint_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 27, column 2 to column 69)",
                                                      " (in 'string', line 28, column 2 to column 43)",
                                                      " (in 'string', line 30, column 4 to column 106)",
                                                      " (in 'string', line 29, column 15 to line 31, column 3)",
                                                      " (in 'string', line 29, column 2 to line 31, column 3)",
                                                      " (in 'string', line 35, column 2 to column 56)",
                                                      " (in 'string', line 36, column 2 to column 27)",
                                                      " (in 'string', line 37, column 2 to column 36)",
                                                      " (in 'string', line 41, column 6 to column 96)",
                                                      " (in 'string', line 40, column 17 to line 42, column 5)",
                                                      " (in 'string', line 40, column 4 to line 42, column 5)",
                                                      " (in 'string', line 45, column 6 to column 59)",
                                                      " (in 'string', line 44, column 22 to line 46, column 5)",
                                                      " (in 'string', line 44, column 4 to line 46, column 5)",
                                                      " (in 'string', line 38, column 18 to line 47, column 3)",
                                                      ...
                                                      " (in 'string', line 27, column 8 to column 11)",
                                                      " (in 'string', line 28, column 8 to column 9)"};
#include <stan_meta_header.hpp>
class model_mod2_timepoint final : public model_base_crtp<model_mod2_timepoint> {
private:
  int N;
  int N_t;
...
public:
  ~model_mod2_timepoint() { }
  
  inline std::string model_name() const final { return "model_mod2_timepoint"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_mod2_timepoint(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mod2_timepoint_namespace::model_mod2_timepoint";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mod2_timepoint_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mod2_timepoint_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"logit_prev_f\",\"type\":{\"name\":\"array\",\"length\":" << N_t << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"sens\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"kappa\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"prev_f\",\"type\":{\"name\":\"array\",\"length\":" << N_t << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"pool_pos\",\"type\":{\"name\":\"array\",\"length\":" << N << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_mod2_timepoint_namespace::model_mod2_timepoint;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mod2_timepoint_namespace::profiles__;
}
#endif
#endif
