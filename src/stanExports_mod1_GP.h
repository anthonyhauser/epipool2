...
namespace model_mod1_GP_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 41, column 19 to column 45)",
                                                      ...
                                                      " (in 'string', line 47, column 4 to column 106)",
                                                      " (in 'string', line 46, column 15 to line 48, column 3)",
                                                      ...
                                                      " (in 'string', line 60, column 6 to column 56)",
                                                      " (in 'string', line 59, column 17 to line 61, column 5)",
                                                      " (in 'string', line 59, column 4 to line 61, column 5)",
                                                      ...
                                                      " (in 'string', line 57, column 18 to line 66, column 3)",
                                                      " (in 'string', line 57, column 2 to line 66, column 3)",
                                                      ...
                                                      " (in 'string', line 34, column 9 to column 12)",
                                                      " (in 'string', line 35, column 9 to column 12)",
                                                      " (in 'string', line 36, column 8 to column 9)",
                                                      " (in 'string', line 37, column 9 to column 12)",
                                                      " (in 'string', line 37, column 14 to column 17)",
                                                      " (in 'string', line 38, column 9 to column 12)",
                                                      " (in 'string', line 38, column 14 to column 17)"};
#include <stan_meta_header.hpp>
class model_mod1_GP final : public model_base_crtp<model_mod1_GP> {
private:
  int N;
  int N_t;
...
public:
  ...
  inline std::string model_name() const final { return "model_mod1_GP"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_mod1_GP(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mod1_GP_namespace::model_mod1_GP";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mod1_GP_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mod1_GP_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"intercept\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << N_t << "},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sens\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"f\",\"type\":{\"name\":\"vector\",\"length\":" << N_t << "},\"block\":\"transformed_parameters\"},{\"name\":\"prev_f\",\"type\":{\"name\":\"vector\",\"length\":" << N_t << "},\"block\":\"transformed_parameters\"},{\"name\":\"pool_pos\",\"type\":{\"name\":\"array\",\"length\":" << N << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"K\",\"type\":{\"name\":\"matrix\",\"rows\":" << N_t << ",\"cols\":" << N_t << "},\"block\":\"transformed_parameters\"},{\"name\":\"L_K\",\"type\":{\"name\":\"matrix\",\"rows\":" << N_t << ",\"cols\":" << N_t << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_mod1_GP_namespace::model_mod1_GP;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mod1_GP_namespace::profiles__;
}
#endif
#endif
