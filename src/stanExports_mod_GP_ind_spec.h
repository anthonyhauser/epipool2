...
namespace model_mod_GP_ind_spec_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 30, column 2 to column 32)",
                                                      ...
                                                      " (in 'string', line 42, column 4 to column 51)",
                                                      " (in 'string', line 43, column 21 to column 53)",
                                                      " (in 'string', line 43, column 4 to column 53)",
                                                      " (in 'string', line 44, column 4 to column 38)",
                                                      " (in 'string', line 45, column 4 to column 28)",
                                                      " (in 'string', line 46, column 4 to column 47)",
                                                      " (in 'string', line 41, column 19 to line 47, column 3)",
                                                      " (in 'string', line 41, column 2 to line 47, column 3)",
                                                      " (in 'string', line 49, column 4 to column 120)",
                                                      " (in 'string', line 48, column 15 to line 50, column 3)",
                                                      " (in 'string', line 48, column 2 to line 50, column 3)",
                                                      " (in 'string', line 71, column 2 to column 38)",
                                                      " (in 'string', line 74, column 6 to column 50)",
                                                      " (in 'string', line 73, column 23 to line 75, column 5)",
                                                      " (in 'string', line 73, column 4 to line 75, column 5)",
                                                      " (in 'string', line 72, column 19 to line 76, column 3)",
                                                      ...
                                                      " (in 'string', line 57, column 4 to column 49)",
                                                      " (in 'string', line 58, column 4 to column 46)",
                                                      " (in 'string', line 54, column 19 to line 59, column 3)",
                                                      ...
                                                      " (in 'string', line 62, column 17 to line 64, column 5)",
                                                      " (in 'string', line 62, column 4 to line 64, column 5)",
                                                      " (in 'string', line 66, column 6 to column 59)",
                                                      " (in 'string', line 65, column 22 to line 67, column 5)",
                                                      " (in 'string', line 65, column 4 to line 67, column 5)",
                                                      " (in 'string', line 61, column 18 to line 68, column 3)",
                                                      " (in 'string', line 61, column 2 to line 68, column 3)",
                                                      ...
                                                      " (in 'string', line 29, column 8 to column 13)",
                                                      " (in 'string', line 30, column 8 to column 13)",
                                                      " (in 'string', line 30, column 22 to column 25)",
                                                      " (in 'string', line 31, column 8 to column 13)",
                                                      " (in 'string', line 32, column 8 to column 13)",
                                                      " (in 'string', line 36, column 8 to column 13)",
                                                      " (in 'string', line 36, column 22 to column 25)",
                                                      " (in 'string', line 37, column 8 to column 13)",
                                                      " (in 'string', line 37, column 22 to column 25)",
                                                      " (in 'string', line 38, column 8 to column 9)",
                                                      " (in 'string', line 39, column 8 to column 13)",
                                                      " (in 'string', line 39, column 22 to column 25)",
                                                      " (in 'string', line 39, column 27 to column 30)",
                                                      " (in 'string', line 40, column 8 to column 13)",
                                                      " (in 'string', line 40, column 22 to column 25)",
                                                      " (in 'string', line 40, column 27 to column 30)",
                                                      " (in 'string', line 71, column 8 to column 13)",
                                                      " (in 'string', line 71, column 15 to column 20)"};
#include <stan_meta_header.hpp>
class model_mod_GP_ind_spec final : public model_base_crtp<model_mod_GP_ind_spec> {
private:
  int N;
  int N_t;
  int N_pop;
...
public:
  ~model_mod_GP_ind_spec() { }
  
  inline std::string model_name() const final { return "model_mod_GP_ind_spec"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = %%NAME%%3 %%VERSION%%", "stancflags = "};
  }
  
  
  model_mod_GP_ind_spec(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mod_GP_ind_spec_namespace::model_mod_GP_ind_spec";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mod_GP_ind_spec_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mod_GP_ind_spec_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"intercept\",\"type\":{\"name\":\"array\",\"length\":" << N_pop << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" << N_pop << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_t << "}},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"array\",\"length\":" << N_pop << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"array\",\"length\":" << N_pop << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"sens\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"f\",\"type\":{\"name\":\"array\",\"length\":" << N_pop << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_t << "}},\"block\":\"transformed_parameters\"},{\"name\":\"prev_f\",\"type\":{\"name\":\"array\",\"length\":" << N_pop << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_t << "}},\"block\":\"transformed_parameters\"},{\"name\":\"pool_pos\",\"type\":{\"name\":\"array\",\"length\":" << N << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"L_K\",\"type\":{\"name\":\"array\",\"length\":" << N_pop << ",\"element_type\":{\"name\":\"matrix\",\"rows\":" << N_t << ",\"cols\":" << N_t << "}},\"block\":\"transformed_parameters\"},{\"name\":\"K\",\"type\":{\"name\":\"array\",\"length\":" << N_pop << ",\"element_type\":{\"name\":\"matrix\",\"rows\":" << N_t << ",\"cols\":" << N_t << "}},\"block\":\"transformed_parameters\"},{\"name\":\"prev_ratio\",\"type\":{\"name\":\"array\",\"length\":" << N_pop << ",\"element_type\":{\"name\":\"array\",\"length\":" << prev_ratio_2dim__ << ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_mod_GP_ind_spec_namespace::model_mod_GP_ind_spec;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mod_GP_ind_spec_namespace::profiles__;
}
#endif
#endif
