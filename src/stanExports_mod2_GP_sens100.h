...
namespace model_mod2_GP_sens100_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 51, column 2 to column 41)",
                                                      " (in 'string', line 52, column 2 to column 27)",
                                                      " (in 'string', line 55, column 6 to column 96)",
                                                      " (in 'string', line 54, column 17 to line 56, column 5)",
                                                      " (in 'string', line 54, column 4 to line 56, column 5)",
                                                      " (in 'string', line 53, column 18 to line 57, column 3)",
                                                      ...
                                                      " (in 'string', line 35, column 14 to column 17)",
                                                      " (in 'string', line 36, column 9 to column 12)",
                                                      " (in 'string', line 36, column 14 to column 17)"};
#include <stan_meta_header.hpp>
class model_mod2_GP_sens100 final : public model_base_crtp<model_mod2_GP_sens100> {
private:
  int N;
  int N_t;
...
public:
  ~model_mod2_GP_sens100() { }
  
  inline std::string model_name() const final { return "model_mod2_GP_sens100"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_mod2_GP_sens100(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_mod2_GP_sens100_namespace::model_mod2_GP_sens100";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_mod2_GP_sens100_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_mod2_GP_sens100_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_mod2_GP_sens100_namespace::model_mod2_GP_sens100;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mod2_GP_sens100_namespace::profiles__;
}
#endif
#endif
